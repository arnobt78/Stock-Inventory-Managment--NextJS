...
const API_WRITE_ROUTE_INVALIDATION_SPEC: Record<string, readonly string[]> = {
  ...
  "app/api/products/import/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/products/image/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/products/qr-code/route.ts": ["scheduleInvalidateAllServerCaches"],
  ...
  "app/api/invoices/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/invoices/[id]/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/invoices/[id]/send/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/invoices/reminders/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/warehouses/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/stock-allocations/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/product-reviews/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/product-reviews/[id]/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/support-tickets/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/support-tickets/[id]/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/support-tickets/[id]/replies/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/users/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/users/[id]/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/user/email-preferences/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/system-config/route.ts": ["invalidateCache(", "scheduleInvalidateAllServerCaches"],
  "app/api/auth/register/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/payments/checkout/route.ts": ["scheduleInvalidateAllServerCaches"],
  ...
  "app/api/notifications/in-app/[id]/route.ts": ["scheduleInvalidateAllServerCaches"],
  "app/api/notifications/in-app/mark-all-read/route.ts": ["scheduleInvalidateAllServerCaches"],
};
