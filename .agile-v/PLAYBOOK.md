...
**Active:** REQ-0185 — ticket table/detail UI (`resume_token: tomorrow-UI-tickets-warehouse-order`)  
**Prod SHA:** `011d655` (REQ-0179–0184) · tip `ceb9097` · **Standard:** Agile V 1.4 | Infinity Loop
