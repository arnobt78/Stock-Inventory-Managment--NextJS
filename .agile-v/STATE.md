...
| **Phase** | C2 — REQ-0121–0127 **done, not yet pushed** |
| **Last updated** | 2026-07-15 (REQ-0127) |
| **Active REQ range** | REQ-0001 … REQ-0127 **done** |
| **Prod deploy target** | `9d7ec21` (REQ-0120) — pushed `origin/main`; REQ-0121–0127 local only |
