...
## Densify coverage (REQ-0218)

**Gold:** order/invoice badges; catalog own-edit merge; stock allocate/transfer + list %#  
**Deferred:** KPI/forecast pulse; cat/sup insights after product/stock CRUD; committed after order; review/ticket/user thin replace
