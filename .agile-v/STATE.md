...
| **Active REQ range** | REQ-0001 … REQ-0037 (REQ-0037 code-complete) |
...
9. **C2 backlog** — user-reported issues + manual QA gaps (see below)
...
| Red Team (latest) | lint ✓ test 335 ✓ invalidate 202 ✓ build ✓ (2026-07-10 REQ-0037) |
