/**
 * Invoice source/type filter for admin combined Invoices view.
 * Options: Client invoices, Personal invoices, View both, Clear.
 */

import React from "react";
import { FileText, User, LayoutGrid } from "lucide-react";
import {
  Popover,
  PopoverTrigger,
  PopoverContent,
...
type InvoiceSourceDropDownProps = {
