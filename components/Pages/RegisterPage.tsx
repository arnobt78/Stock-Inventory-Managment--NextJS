...
import { BarChart3, Shield, Zap, CheckCircle2, Sparkles } from "lucide-react";
        ...
        <div className="flex flex-col lg:flex-row min-h-screen">
          ...
          <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-4 sm:p-6 lg:p-12">
            ...
            <div className="relative z-10 max-w-lg w-full space-y-4">
              {/* Main Welcome Card */}
              <div className="rounded-[28px] border border-emerald-400/30 dark:border-white/10 bg-gradient-to-br from-emerald-500/25 via-emerald-500/10 to-emerald-500/5 dark:from-white/5 dark:via-white/5 dark:to-white/5 backdrop-blur-md shadow-[0_30px_80px_rgba(16,185,129,0.35)] dark:shadow-lg p-4 sm:p-6">
                <h1 className="text-lg sm:text-xl font-medium text-gray-700 dark:text-white mb-3 tracking-tight text-center">
                  Transform Your Warehouse
                </h1>
                <p className="text-md sm:text-lg text-gray-700 dark:text-white/80 font-medium leading-relaxed text-center">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="rounded-[20px] border border-blue-400/30 dark:border-white/10 bg-gradient-to-br from-blue-500/25 via-blue-500/10 to-blue-500/5 dark:from-white/5 dark:via-white/5 dark:to-white/5 backdrop-blur-md shadow-[0_20px_60px_rgba(59,130,246,0.35)] dark:shadow-lg p-4 transition-all hover:shadow-[0_25px_70px_rgba(59,130,246,0.45)] hover:border-blue-300/50 dark:hover:border-blue-300/40">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="rounded-xl border border-blue-400/30 dark:border-blue-400/20 bg-blue-500/20 dark:bg-blue-500/10 backdrop-blur-md p-2">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-0 sm:p-4 lg:p-12">
            <div className="w-full max-w-md space-y-4 rounded-[28px] border border-emerald-400/30 dark:border-white/10 bg-gradient-to-br from-emerald-500/25 via-emerald-500/10 to-emerald-500/5 dark:from-white/5 dark:via-white/5 dark:to-white/5 backdrop-blur-md shadow-[0_30px_80px_rgba(16,185,129,0.35)] dark:shadow-lg p-4 sm:p-6 transition-all duration-300 hover:shadow-[0_40px_100px_rgba(16,185,129,0.5)] dark:hover:shadow-[0_40px_100px_rgba(16,185,129,0.4)] hover:border-emerald-300/50 dark:hover:border-emerald-300/30">
